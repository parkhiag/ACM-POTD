...
I am currently participating in ACM-POTD challenge.  
This repository documents my daily solutions.

---

## 🎯 Challenge Details
- 📅 Start Date: 23-03-2026
- 🧩 Problems: Min 1 per day
- 🎯 Goal: Build strong problem-solving intuition and consistency

---

## 🗂️ Progress Log

| Day | Problem | Level | Link |
|-----|---------|-------|------|
| Day 2 | Two Sum | Beginner | [view](/ParkhiAgarwal_23-3-26_Day-2.md) |
